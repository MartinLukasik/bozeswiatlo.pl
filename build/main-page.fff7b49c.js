parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    nHMT: [
      function (require, module, exports) {
        'use strict';
        var e = n(require('lodash.debounce'));
        function n(e) {
        ...
        t(),
          window.addEventListener(
            'resize',
            (0, e.default)(t, 500, { leading: !1, trailing: !0 })
          );
      },
    ...
    OrXF: [
      function (require, module, exports) {
        module.exports = '/2m.17eaeb7b.webp';
      },
      {},
    ],
    VtMg: [
      function (require, module, exports) {
        module.exports = '/3m.a5db8f8a.webp';
      },
      {},
    ],
    T31O: [
      function (require, module, exports) {
        module.exports = '/2.d453a35d.webp';
      },
      {},
    ],
    BN3d: [
      function (require, module, exports) {
        module.exports = '/3.754f8991.webp';
      },
      {},
    ],
    F5eC: [
      function (require, module, exports) {
        'use strict';
        var e = l(require('../../img/slider/2m.webp')),
          t = l(require('../../img/slider/3m.webp')),
          n = l(require('../../img/slider/2.webp')),
          r = l(require('../../img/slider/3.webp'));
        function l(e) {
          return e && e.__esModule ? e : { default: e };
        }
        var i = [null, e.default, t.default],
          u = [null, n.default, r.default],
          a = 9e3,
          s = function (e) {
            ...
            document
              ...
              .addEventListener('click', function () {
                n(), clearInterval(l), (l = setInterval(n, e));
              }),
              document
                .getElementById('prev')
                .addEventListener('click', function () {
                  r(), clearInterval(l), (l = setInterval(n, e));
                }),
              (l = setInterval(n, e));
            var n = function () {
                var e = document.querySelector('.current');
                (e.nextElementSibling || t[0]).classList.add('current'),
                  e.classList.remove('current'),
                  e.firstElementChild.classList.remove('animation-paused');
              },
              r = function () {
                var e = document.querySelector('.current');
                (e.nextElementSibling || t[t.length - 1]).classList.add(
                  'current'
                ),
                  e.classList.remove('current'),
                  e.classList.remove('animation-paused');
              },
              l = setInterval(n, e);
            document.addEventListener('keydown', function (e) {
              '37' == e.keyCode ? r() : '39' == e.keyCode && n();
            });
          };
        s(a);
      },
      {
        '../../img/slider/2m.webp': 'OrXF',
        '../../img/slider/3m.webp': 'VtMg',
        '../../img/slider/2.webp': 'T31O',
        '../../img/slider/3.webp': 'BN3d',
      },
    ],
    Ypir: [
      function (require, module, exports) {
        'use strict';
        var e = s(require('lodash.debounce'));
        function s(e) {
          return e && e.__esModule ? e : { default: e };
        }
        ...
        function i() {
          ...
          var e = document.querySelector('.current');
          window.scrollY
            ? e.firstElementChild.classList.add('animation-paused')
            : e.firstElementChild.classList.remove('animation-paused');
        }
        window.scrollY && i(),
          window.addEventListener(
            'scroll',
            (0, e.default)(i, 150, { leading: !0, trailing: !0 })
          );
      },
      { 'lodash.debounce': 'TZhv' },
    ],
    ...
    xIJa: [
      function (require, module, exports) {
        function e() {
          var e = document.querySelector('.quote-quote'),
            t = document.querySelector('.quote-src'),
            o = JSON.parse(this.responseText);
          (e.textContent = o.quote), (t.textContent = o.src);
        }
        function t() {
          var e = document.querySelector('.quote-quote'),
            t = document.querySelector('.quote-src');
          (e.textContent = 'verse.quote'), (t.textContent = 'verse.src');
        }
        function o(e) {
          var o = new XMLHttpRequest();
          o.addEventListener('load', e),
            o.addEventListener('error', t),
            o.open('GET', '/api/verses/random'),
            o.send();
        }
        o(e);
      },
    ...
    mIbi: [
      function (require, module, exports) {
        'use strict';
        var t = n(require('../../img/canvas-bg.webp'));
        function n(t) {
        ...
        var i = document.getElementById('canvas'),
          ...
          a = (i.height = 0.55 * window.innerHeight),
          h = new Image(),
          o = {},
          d = [],
          w = [],
          ...
          g = function () {
            return (
              l(),
              (h.onload = function (t) {
                (o.width = t.path ? t.path[0].width : t.target.width),
                  (o.height = t.path ? t.path[0].height : t.target.height);
                var n =
                  Math.ceil(window.innerWidth / o.width) *
                  Math.ceil(window.innerHeight / o.height);
                v(),
                  window.matchMedia('(min-width: 500px)').matches && m(15 * n),
          ...
          v = function () {
            for (
              var t = {
                  row: Math.ceil(window.innerWidth / (0.4 * o.width)),
                  cols: Math.ceil(window.innerHeight / (0.4 * o.height)),
                  rowWidth: 0.4 * o.width,
                  colHeight: 0.4 * o.height,
                },
                n = 0,
                i = t.row,
                e = 0 <= i;
              ...
              for (
                var r = n * t.rowWidth, a = 0, h = t.cols, d = 0 <= h;
                d ? a < h : a > h;
                d ? a++ : a--
              ) {
                var u = new p(r, a * t.colHeight, t.rowWidth, t.colHeight);
                w.push(u);
              }
            return x(0, w.length, !1).map(function (t) {
              return w[t].draw();
            });
          },
          p = function (t, n, i, r) {
            null == t && (t = 0),
              null == n && (n = 0),
              (this.draw = function () {
                e.drawImage(h, t, n, i, r);
              });
          },
          M = function () {
            var t = 2.5 * Math.random() + 1,
              n = o.width / t,
              i = o.height / t,
              r = window.innerWidth * Math.random(),
              a = r,
              d = window.innerHeight * Math.random(),
              w = d,
              g = 360 * Math.random() - 180,
              l = 0,
              s = 0,
              f = Math.PI / 180;
            (this.update = function () {
              var t = r,
                ...
                e = c.y - n,
                h = Math.sqrt(i * i + e * e);
              (r = t - ((i / h) * u) / h + (l = (l + (a - t) / 2) / 2.1)),
                (d = n - ((e / h) * u) / h + (s = (s + (w - n) / 2) / 2.2));
            }),
              (this.draw = function () {
                return H(e, h, g * f, r, d, n / 2, i / 2, n, i);
              });
          },
          H = function (t, n, i, e, r, a, h, o, d) {
            return (
              t.translate(e, r),
              t.rotate(i),
              t.drawImage(n, -a, -h, o, d),
              t.rotate(-i),
              t.translate(-e, -r)
            );
          },
          W = function t() {
            var n = 0,
              i = 0;
            for (e.clearRect(0, 0, r, a); i < w.length; ) w[i].draw(), i++;
            for (; n < d.length; ) d[n].update(), d[n].draw(), n++;
            return requestAnimationFrame(t);
          };
        function x(t, n, i) {
          for (
            var e = [], r = t < n, a = i ? (r ? n + 1 : n - 1) : n, h = t;
            r ? h < a : h > a;
            r ? h++ : h--
          )
            e.push(h);
    ...
    nNu6: [
      function (require, module, exports) {
        ...
        var e = document.querySelectorAll('.m-card');
        function r(e) {
          e.addEventListener('mouseenter', function () {
            return setTimeout(function () {
              return e.classList.add('scroll-y');
            }, 150);
          }),
            e.addEventListener('mouseleave', function () {
              return setTimeout(function () {
                e.classList.remove('scroll-y'), (e.scrollTop = 0);
              }, 200);
            });
        }
        e.forEach(function (e) {
      ...
      {
        './modules/css-custom-props': 'nHMT',
        './modules/slider': 'F5eC',
        './modules/scrollHandler': 'Ypir',
        './modules/resonsive-nav': 'WXfQ',
        './modules/aos': 'PTNx',
        './modules/bible-api': 'xIJa',
        './modules/background-animation': 'mIbi',
      },
    ],
  },
  {},
...
//# sourceMappingURL=/main-page.fff7b49c.js.map
