        ...
        var e = 9e3,
          t = function (e) {
            ...
            var n = function () {
              ...
              r = function () {
                var e = document.querySelector('.current');
                (e.previousElementSibling || t[t.length - 1]).classList.add(
                  'current'
                ),
                  e.classList.remove('current'),
      ...
      function (require, module, exports) {
        function e() {
          var e = document.querySelector('.quote-quote'),
            n = document.querySelector('.quote-src');
          try {
            var o = JSON.parse(this.responseText);
            (e.textContent = o.quote), (n.textContent = o.src);
          } catch (r) {
            console.error('Cannot fetch api: '.concat(r.message)), t();
          }
        }
        function t() {
          var e = document.querySelector('.quote-quote'),
          ...
          (e.textContent =
            ...
            (t.textContent = '2-е Тимофею 4:8');
        }
        function n(e) {
          var n = new XMLHttpRequest();
          n.addEventListener('load', e),
            n.addEventListener('error', t),
            n.open('GET', '/api/verses/random'),
            n.send();
        }
        n(e);
      },
    ...
    mIbi: [
      function (require, module, exports) {
        ...
        function W() {
          var t = 0,
            n = 0;
          for (e.clearRect(0, 0, r, a); n < w.length; ) w[n].draw(), n++;
          for (; t < d.length; ) d[t].update(), d[t].draw(), t++;
...
//# sourceMappingURL=/main-page.20ccc65c.js.map
